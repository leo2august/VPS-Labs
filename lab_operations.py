...
LAB_OPTIONS = {
    "brand_name": {"label": "Nama Branding", "description": "Nama header/sidebar/login — isi bebas (mis. nama perusahaan atau tim).", "type": "text", "default": "VPS Labs"},
    "brand_sub": {"label": "Sub-judul Branding", "description": "Teks kecil di bawah nama (mis. Laboratory, Command Center).", "type": "text", "default": "Server Management"},
    "timezone": {"label": "Zona Waktu", "description": "Zona waktu untuk jam realtime & semua tampilan waktu.", "choices": [["Asia/Jakarta", "WIB — Jakarta (UTC+7)"], ["Asia/Makassar", "WITA — Makassar (UTC+8)"], ["Asia/Jayapura", "WIT — Jayapura (UTC+9)"], ["Asia/Singapore", "Singapore (UTC+8)"], ["Asia/Bangkok", "Bangkok (UTC+7)"], ["Asia/Hong_Kong", "Hong Kong (UTC+8)"], ["Asia/Tokyo", "Tokyo (UTC+9)"], ["Asia/Shanghai", "Beijing (UTC+8)"], ["Asia/Kolkata", "India (UTC+5:30)"], ["Asia/Dubai", "Dubai (UTC+4)"], ["Asia/Riyadh", "Riyadh (UTC+3)"], ["Europe/London", "London (UTC+0)"], ["Europe/Paris", "Paris (UTC+1)"], ["Europe/Berlin", "Berlin (UTC+1)"], ["Europe/Moscow", "Moscow (UTC+3)"], ["America/New_York", "New York (UTC-5)"], ["America/Chicago", "Chicago (UTC-6)"], ["America/Denver", "Denver (UTC-7)"], ["America/Los_Angeles", "Los Angeles (UTC-8)"], ["America/Sao_Paulo", "São Paulo (UTC-3)"], ["Australia/Sydney", "Sydney (UTC+10)"], ["Pacific/Auckland", "Auckland (UTC+12)"], ["Pacific/Honolulu", "Honolulu (UTC-10)"], ["GMT", "GMT (UTC+0)"], ["UTC", "UTC"]], "default": "Asia/Jakarta"},
    ...
    "language": {"label": "Bahasa Labs", "description": "Bahasa label dan bantuan antarmuka Labs.", "choices": [["id", "Bahasa Indonesia"], ["en", "English"], ["ja", "日本語 — Jepang"], ["zh", "中文 — Mandarin"], ["ko", "한국어 — Korea"], ["es", "Español — Spanyol"]], "default": "id"},
